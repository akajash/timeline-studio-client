...
import { fetchDesignation } from '../../actions/designation.js';
    ...
    if(totalPages <= 3){
        middlePagination = [...Array(totalPages)].map((_,idx) => (
            <PaginationItem className = {currentPage === idx ? "active" : ""}>
                      <PaginationLink
                        key={idx+1}
                        onClick={() => dispatch(fetchDesignation(idx+1))}
        ...
        middlePagination = [...Array(3)].map((_,idx) => (
                ...
                <PaginationLink
                  ...
                  onClick={() => dispatch(fetchDesignation(startValue + idx + 1))}
                  disabled={currentPage === idx + 1}
                >
                  {startValue + idx + 1}
                </PaginationLink>
                ...
                <nav aria-label="...">
                  ...
                  >
                    {!(currentPage == 1) && (<PaginationItem>
                      <PaginationLink
                        href="#pablo"
                        onClick={() => dispatch(fetchDesignation(currentPage - 1))}
                        tabIndex="-1"
                      >
