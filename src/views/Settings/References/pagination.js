...
import { fetchReferences } from '../../../actions/references.js';
    ...
    if(totalPages <= 3){
        middlePagination = [...Array(totalPages)].map((_,idx) => (
            <PaginationItem className = {currentPage === idx ? "active" : ""}>
                      <PaginationLink
                        key={idx+1}
                        onClick={() => dispatch(fetchReferences(idx+1))}
        ...
        middlePagination = [...Array(3)].map((_,idx) => (
                ...
                <PaginationLink
                  ...
                  onClick={() => dispatch(fetchReferences(startValue + idx + 1))}
                  disabled={currentPage === idx + 1}
                >
                  {startValue + idx + 1}
                </PaginationLink>
                ...
                <nav aria-label="...">
                  ...
                  >
                    {!(currentPage == 1) && (<PaginationItem>
                      <PaginationLink
                        href="#pablo"
                        onClick={() => dispatch(fetchReferences(currentPage - 1))}
                        tabIndex="-1"
                      >
