...
import { fetchPackages } from '../../../actions/packages.js';
    ...
    if(totalPages <= 3){
        middlePagination = [...Array(totalPages)].map((_,idx) => (
            <PaginationItem className = {currentPage === idx ? "active" : ""}>
                      <PaginationLink
                        key={idx+1}
                        onClick={() => dispatch(fetchPackages(idx+1))}
        ...
        middlePagination = [...Array(3)].map((_,idx) => (
                ...
                <PaginationLink
                  ...
                  onClick={() => dispatch(fetchPackages(startValue + idx + 1))}
                  disabled={currentPage === idx + 1}
                >
                  {startValue + idx + 1}
                </PaginationLink>
                ...
                <nav aria-label="...">
                  ...
                  >
                    {!(currentPage == 1) && (<PaginationItem>
                      <PaginationLink
                        href="#pablo"
                        onClick={() => dispatch(fetchPackages(currentPage - 1))}
                        tabIndex="-1"
                      >
